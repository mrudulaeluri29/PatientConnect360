      ...
      <div className="login-container">
        <div className="login-left">
          <div className="login-branding">
            ...
            <p className="login-subtitle">
              Create an admin account to manage the MediHealth platform and oversee system operations
            </p>
          </div>
        ...
        <div className="login-right">
          <div className="login-form-container">
            ...
            <p className="form-subtitle">Register as an administrator</p>
            ...
            <Link to="/admin/login" className="btn-signup-link">
              Sign In
            </Link>
          </div>
        </div>
