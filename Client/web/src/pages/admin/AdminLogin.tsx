      ...
      <div className="login-container">
        <div className="login-left">
          ...
          <div className="login-features">
            <div className="feature-item"><span>System Administration</span></div>
            <div className="feature-item"><span>User Management</span></div>
            <div className="feature-item"><span>Analytics & Reports</span></div>
            <div className="feature-item"><span>Platform Settings</span></div>
          </div>
        </div>
