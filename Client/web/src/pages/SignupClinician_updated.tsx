...
export default function SignupClinician() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Prepare clinician profile data
      const profileData = {
      ...
      await register(formData.email, formData.username, formData.password, "CLINICIAN", profileData);
      ...
      <div className="signup-container">
        ...
        <div className="signup-right">
          <div className="signup-form-container">
            ...
            <p className="form-subtitle">Create your clinician account</p>
            ...
            <form onSubmit={handleSubmit} className="signup-form">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  required
                  disabled={loading}
                  className={errors.hospitalAffiliation ? "error" : ""}
                />
